"""
Pipeline Runner for Healthcare BE Technical Documentation Project
"""
import sys
...
class HealthcareBETechDocsStepRegistry(StepRegistry):
    """Registry for Healthcare BE Technical Documentation project steps."""
    
    def _register_default_steps(self):
        """Register the Healthcare BE Technical Documentation project steps."""
        try:
            print("Registering Healthcare BE Technical Documentation steps...")
            ...
            print("✅ All Healthcare BE Technical Documentation steps registered successfully!")
...
def main():
    """Main CLI interface for Healthcare BE Technical Documentation project."""
    # Create runner with custom registry
    runner = PipelineRunner()
    runner.registry = HealthcareBETechDocsStepRegistry()
    
    if len(sys.argv) < 2:
        print(f"\n🏥 {project_config.project_name} - Technical Documentation Pipeline")
        print("=" * 75)
        print("🎯 Target: Healthcare BE System (/home/dd/work/codes/HEALTHCARE/healthcare-api)")
    ...
    if command == "list":
        ...
        if sys.argv[2].lower() == "all":
            print(f"\n🚀 Running complete Healthcare BE Technical Documentation pipeline...")
            print("=" * 75)
            runner.run_steps()
        elif len(sys.argv) == 3:
            try:
                step_num = int(sys.argv[2])
                print(f"\n🚀 Running Step {step_num} for Healthcare BE Technical Documentation...")
                print("=" * 75)
            ...
            try:
                ...
                print(f"\n🚀 Running Steps {start_step}-{end_step} for Healthcare BE Technical Documentation...")
                print("=" * 75)
